// VECN1WS1 at 23/08/2016 05:34:53
'use strict';
if (typeof veTagData === 'undefined') {
    var veTagData = (function () {
        var b,
            ...
            d = {
                journeycode: 'A6F37EE1-2328-475D-9E9A-892A48E3646B',
  ...
  Forms: [
    {
      ...
      FormFields: [
        {
          ClientFieldName: ".pageshowbig .zoomPad img:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 3000807,
        ...
        {
          ClientFieldName: ".pageshowBox h1",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 3000808,
        ...
        {
          ClientFieldName: "#postPrice",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 3000809,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".xhxcolor:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 3000811,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".categorybread a:last",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 3000812,
          HtmlAttributeTag: "Value",
          HtmlType: "a",
          IdentifyAbandonment: false,
          isEmail: false,
    ...
    },
    {
      ...
      FormFields: [
        {
          ClientFieldName: "logininputname",
          DomEvent: "DynamicActivity",
          FieldTypeName: "Id",
          FormMappingId: 3001491,
          HtmlAttributeTag: "Value",
          HtmlType: ":text",
          IdentifyAbandonment: false,
          isEmail: true,
      ...
      FormTypeId: 1,
      FormURLs: [
        "aimer.com.cn/passport/reglog",
        "aimer.com.cn/passport/login"
      ],
      IdentifyAbandonmentOr: true,
      NumberIdentifiedFields: 0,
      Name: null,
    ...
    },
    {
      ...
      FormFields: [
        {
          ClientFieldName: ".carBg .carCImg",
          DomEvent: "OnLoad",
          FieldTypeName: "RawSeries",
          FormMappingId: 3001466,
          HtmlAttributeTag: "src",
          HtmlType: "img",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".carCName a",
          DomEvent: "OnLoad",
          FieldTypeName: "RawSeries",
          FormMappingId: 3001467,
          HtmlAttributeTag: "Value",
          HtmlType: "a",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".carContent td:nth-child(6)",
          DomEvent: "OnLoad",
          FieldTypeName: "RawSeries",
          FormMappingId: 3001469,
          HtmlAttributeTag: "Value",
          HtmlType: "td",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".inputNumber",
          DomEvent: "DynamicActivity",
          FieldTypeName: "RawSeries",
          FormMappingId: 3001470,
          HtmlAttributeTag: "Value",
          HtmlType: ":text",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".carShiftListCon .amount",
          DomEvent: "DynamicActivity",
          FieldTypeName: "Raw",
          FormMappingId: 3001471,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
    ...
    },
    {
      ...
      FormFields: [
        {
          ClientFieldName: ".paytop span b:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 3001490,
          HtmlAttributeTag: "Value",
          HtmlType: "font",
          IdentifyAbandonment: false,
          isEmail: false,
    ...
    },
    {
      ...
      FormFields: [
        {
          ClientFieldName: ".carLookInput",
          DomEvent: "DynamicActivity",
          FieldTypeName: "Raw",
          FormMappingId: 3001493,
          HtmlAttributeTag: "Value",
          HtmlType: ":text",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: "orderMoney",
          DomEvent: "OnLoad",
          FieldTypeName: "Id",
          FormMappingId: 3001494,
          HtmlAttributeTag: "Value",
          HtmlType: "div",
          IdentifyAbandonment: false,
          isEmail: false,
  ...
  OptOutField: 0
                 ...
                 */
                settings: { domainsToIgnore: ['aimer.com.cn' ], consoleMessagesEnabled: true,
...
appsForms:[{
 appName: 'chat',
 appAgents: ['3000091','3000103','3000101'],
 priority: 1,
...
elementsStoppingAppsOnEvent: [
    {
        elementQuery : '.carJsBut',
        eventType : 'mousedown',
        doesElementExistOnLoad: true
},
{
        elementQuery : '.carBarBut',
        eventType : 'mousedown',
        doesElementExistOnLoad: true
},
{
...
veAds: {
                    config: {
                    timeStamp: "Thu Jan 07 2016 17:19:35 GMT+0800 (China Standard Time)",
                    version: "2.0.0",
                    uuid: "x6r",
                    avoidDOM: false,
	...
	},
	{
		...
		capture:{
			type: "selector",
			mappingCriteria: "contains",
			element: ".carShiftListCon .amount",
			keepChecking: false,
			useMappings: false
		},
		pages:[1]
...
window.veTagData.customEvents.veAds();
    ...
    if (e.length) {
      var i;
      for (i = 0; i < e.length; i++) e[i].addEventListener("mouseup", function() {
        VeAPI && VeAPI.manager && VeAPI.manager.delay && VeAPI.manager.delay()
      })
    }
    var stopArray = ['.carJsBut','.carBarBut','#submit'];
    stopArray.forEach(function(element) {
      var elements = document.querySelectorAll(element);
      if (elements.length) {
        var i;
        for (i = 0; i < elements.length; i++) {
          elements[i].addEventListener("mousedown", function(event) {
            if (VeAPI && VeAPI.manager && VeAPI.manager.stop) {
              VeAPI.manager.stop();
            }
          });
        }
...
veAds: function(){
                ...
                apps: [
  {
    ...
    minTimeBetweenActivations: 20160,
    exitIntent: false
  }
]
            };
